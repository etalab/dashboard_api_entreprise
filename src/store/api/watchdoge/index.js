...
const API_URL = `${process.env.VUE_APP_WATCHDOGE_API_BASE_URL}${
  process.env.VUE_APP_WATCHDOGE_URL_PREFIX
}`;
...
const actions = {
  get(ctx, { url, params = {} }) {
    return new Promise((resolve, reject) => {
      http.get(url, { params }).then(response => resolve(response.data));
